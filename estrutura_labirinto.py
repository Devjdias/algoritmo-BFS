...
CELL = 16  # intervalo entre as coordenadas de células vizinhas

# Mapa do labirinto: W = parede, E = objetivo/saída, espaço = caminho livre.
# Cada posição livre é um estado; buscamos ir de INICIO até E.
MAPA = [
...
def vizinhos(coord, paredes=PAREDES, largura=LARGURA, altura=ALTURA, cell=CELL):
    """Retorna os vizinhos livres dentro dos limites do mapa."""
    # Cima, baixo, esquerda e direita, sem atravessar paredes.
    # Cada movimento até uma célula vizinha custa 1; não há diagonais.
    cx, cy = coord
